...
public class PaintFragment extends BaseFragment implements View.OnClickListener, ImageEditInte {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPaintModeViewLl = (LinearLayout) mainView.findViewById(R.id.paint_thumb_ll);
        colorSeekBar = (ColorSeekBar) mainView.findViewById(R.id.colorSlider);
        mRevokeView = (LinearLayout) mainView.findViewById(R.id.paint_revoke);
        return mainView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mPaintModeViewLl.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v == mPaintModeViewLl) {//设置绘制画笔粗细
            setStokeWidth();
...
//        this.mPaintView.setVisibility(View.VISIBLE);
    ...
    private void initStokeWidthPopWindow() {
        ...
        mPaintModeView.setPaintStrokeWidth(5);
